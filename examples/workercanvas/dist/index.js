  ...
  var GraphNode = class {
    constructor(properties = {}, parentNode, graph) {
      ...
      this.setOperator = (operator) => {
        ...
        let pass = false;
        if (params)
          pass = params.keys().next().value === "origin";
