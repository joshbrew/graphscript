...
export * from './packages/core/graph/index'
export * from './packages/core/loaders'
...
export * from  './packages/graphscript-html-loader/index'
export { DOMElement, addCustomElement } from './packages/graphscript-html-loader/DOMElement'
export * from  './packages/graphscript-html-loader/webcomponents/index' //includes the web component spec, html loader is a little leaner otherwise
